...
const programs = [
  {
    ...
    harga_mulai: "Rp 31.500.000",
    poster_image: "/Umrah_Agustus_11D_REV.png",
    ...
    sort_order: 1,
    harga_detail: [
      { city: "Pangkal Pinang (PGK)", price: "Rp 31.500.000" },
      { city: "Jakarta (CGK)", price: "Rp 28.300.000" },
    ],
  ...
  },
  {
    ...
    poster_image: "/Umrah_Ekslusif_September_10D_REV.png",
    hotel_makkah: "Sofwah / ZamzamTower /setaraf",
    hotel_madinah: "Dallah Taiba / Sanabel /setaraf",
    maskapai: "Saudia / Garuda Indonesia",
  ...
  },
  {
    ...
    poster_image: "/Umrah_Reguler_September_12D_REV.png",
    hotel_makkah: "Grand Al Massa /setaraf",
    hotel_madinah: "Daar El Naeem /setaraf",
    maskapai: "Saudia / Garuda Indonesia",
    bonus_program: "City Tour Bonus Thaif",
  ...
  },
  {
    ...
    nama_program: "Umrah Reguler Special Oktober 10 Hari",
    subtitle: "Paket umrah reguler spesial Oktober dengan harga terjangkau",
    bulan_keberangkatan: "Oktober 2026",
    durasi_hari: "10 Hari",
    kota_keberangkatan: "Pangkal Pinang / Jakarta",
    harga_mulai: "Rp 29.900.000",
    poster_image: "/Umrah_Reguler_Oktober_10D_REV.png",
    hotel_makkah: "Grand Al Massa /setaraf",
    hotel_madinah: "Daar El Naeem /setaraf",
    maskapai: "Saudia / Garuda Indonesia",
    bonus_program: "City Tour Bonus Thaif",
  ...
  {
    slug_url: "umrah-reguler-oktober-12d",
    nama_program: "Umrah Reguler Special Oktober 12 Hari",
    subtitle: "Paket umrah reguler spesial Oktober program 12 hari",
    bulan_keberangkatan: "Oktober 2026",
    durasi_hari: "12 Hari",
    kota_keberangkatan: "Pangkal Pinang / Jakarta",
    harga_mulai: "Rp 33.500.000",
    poster_image: "/Umrah_Reguler_Oktober_12D_REV.png",
    hotel_makkah: "Grand Al Massa /setaraf",
    hotel_madinah: "Daar El Naeem /setaraf",
    maskapai: "Saudia / Garuda Indonesia",
    bonus_program: "City Tour Bonus Thaif",
