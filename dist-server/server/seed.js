...
const waText = (program, bulan) => `${waBase}?text=${encodeURIComponent(`Assalamualaikum, saya tertarik dengan paket ${program} bulan ${bulan} dari El Massa Tour. Mohon informasi lebih lanjut. Terima kasih 🙏`)}`;
const programs = [
    {
    ...
    },
    {
        ...
        nama_program: "Umrah Reguler Oktober",
    ...
    },
    {
        ...
        nama_program: "Umrah Spesial Oktober",
        subtitle: "Paket umrah spesial Oktober program 12 hari pilihan terbaik",
        bulan_keberangkatan: "Oktober 2026",
        durasi_hari: "12 Hari",
        kota_keberangkatan: "Pangkal Pinang / Jakarta",
        harga_mulai: "Rp 33.500.000",
